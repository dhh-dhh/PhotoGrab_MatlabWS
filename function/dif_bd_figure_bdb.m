function [txy_rms_unit,txy_all_unit1]=dif_bd_figure_bdb(positions_now,biaoding,param_x1,param_y1,unit,Z_D_x,Z_D_y)
...
% figure()
% scatterbar3(xx(:,1),yy(:,1),txy_all_unit1,2000)
% colorbar;