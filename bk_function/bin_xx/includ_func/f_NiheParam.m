function [param_x,param_y,dblCoorX,dblCoorY,cha_x,cha_y,cha] = NiheParam(biaoding,x,y,lilun_x,lilun_y,mytitle)
...
if biaoding ==5
    ...
    param_x = lsqcurvefit(@bianhuan,[0 0 200 200 0],p,q,[-8000,-8000,100,100,-2],[8000,8000,1000,1000,2],options);
    param_y=[];
    dblCoorX=[];dblCoorY=[];
...
% function testdata()
% biaoding=56; % biaoding可以分别等于56,42,30,20,12,6；
